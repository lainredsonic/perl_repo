 ...
 */
extern int qqwry_get(char *addr1,char *addr2,const char *ip,const char *qqwry_file_name);
extern int qqwry_get_location(char *addr1,char *addr2,const char *ip,FILE *qqwry_file);
extern int qqwry_get_location_by_long(char *addr1,char *addr2,const uint32_t ip,FILE *qqwry_file);
